...
public interface TicketRepository extends JpaRepository<Ticket, Integer> {
    ...
    @Query("SELECT t FROM Ticket t where t.booking.bookingReference = :bookingReference")
    List<Ticket> findTicketsByBookingReference(@Param("bookingReference") String bookingReference);
}
